package com.example.traveller.sliderimage;
...
import com.example.traveller.model.Image;
...
public class SliderImageCardAuto extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        tab_layout = findViewById(R.id.tabbed_layout);
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        ...
                        finish();
                        Intent intent1 = new Intent(SliderImageCardAuto.this, ProfileDrawerImage.class);
