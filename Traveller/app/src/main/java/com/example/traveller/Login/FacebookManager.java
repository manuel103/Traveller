...
public class FacebookManager {
    ...
    private Call<com.example.traveller.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<com.example.traveller.entities.AccessToken>() {
            @Override
            public void onResponse(Call<com.example.traveller.entities.AccessToken> call, Response<com.example.traveller.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<com.example.traveller.entities.AccessToken> call, Throwable t) {
